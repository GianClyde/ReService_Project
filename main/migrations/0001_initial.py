# Generated by Django 4.2 on 2023-04-16 01:53
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('ADMIN', 'Admin'), ('STUDENT', 'Student'), ('DRIVER', 'Driver')], default='ADMIN', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assigned_route', models.CharField(blank=True, max_length=100, null=True)),
                ...
                ('franchise_no', models.CharField(blank=True, max_length=100, null=True)),
        ...
        migrations.AddField(
            ...
            name='vehicle',
            field=models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to='main.vehicle'),
        ),
        migrations.CreateModel(
            name='DriverUser',
            fields=[
